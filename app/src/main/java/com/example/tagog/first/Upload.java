...
public class Upload extends AppCompatActivity {
    ...
    String ServerUploadPath ="https://androidjsonblog.sultantec.com/img_upload_to_server.php" ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UploadImageServer = (Button)findViewById(R.id.button3);
    ...
    public void ImageUploadToServerFunction(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(Upload.this," جاري رفع الصورة "," الرجاء الانتظار",false,false);
            }
