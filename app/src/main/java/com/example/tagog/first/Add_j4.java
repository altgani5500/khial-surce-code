...
public class Add_j4 extends Activity {
...
int vl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_j3);
...
//                }, 5000);
        ...
        TextView wwww =(TextView)findViewById(R.id.textView40);
        ...
        Button etUserName2342 = (Button) findViewById(R.id.button2222);
        etUserName2342.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View vvv) {
                Intent al = new Intent(Add_j4.this, New_gi.class);

                String aa = getIntent().getStringExtra("g");
                String bb = getIntent().getStringExtra("h");
...
//                Intent alvvwefrerxx = new Intent(Add_j4.this, Watting.class);
//
//                String aa1 = getIntent().getStringExtra("g");
//                String  bb1 = getIntent().getStringExtra("h");
//                String   bb2 = "1";
//                String bb3 = getIntent().getStringExtra("j");
//
...
//                overridePendingTransition(R.anim.pull_in_left, R.anim.push_out_right);
                ...
                Intent alvvwefrerxx = new Intent(Add_j4.this, Watting_u.class);
...
*/
    ...
    protected void showList(){
        try {
             ...
             // String DD2 ="من"+c.getString(D)+"الي"+c.getString(E);
              // String GG2 ="من"+c.getString(G)+"الي"+c.getString(H);
                ...
                String count=anArray[positiona];
                      ...
                      Intent alvvwefrerxx = new Intent(Add_j4.this, Users_info2.class);
            ...
            ListAdapter adapter = new SimpleAdapter(Add_j4.this, personList, R.layout.list_item222, new String[]{D,E,H,F,G},


                    new int[]{R.id.textViewTitle,R.id.textView19,R.id.textViewTitle1,R.id.textView23,R.id.textView32
            ...
            e.printStackTrace();
            Toast.makeText(getApplicationContext(), "توجد مشكلة ما ", Toast.LENGTH_LONG).show();
        }
        ...
        }else
        {
           ...
           // Toast.makeText(Driver.this, "Position: " + vl, Toast.LENGTH_SHORT).show();
            ...
            etUserName.setVisibility(View.VISIBLE);
//            Drawable img = getContext().getResources().getDrawable( R.drawable.addp );
//            etUserName.setCompoundDrawables(null,img,null,null);

           // etUserName.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.addp, 0, 0);
            etUserName.setCompoundDrawablesWithIntrinsicBounds(null,null,null,null);
            etUserName.setText("لا توجد لديك رحلات معروضة ");
        ...
        class GetDataJSON extends AsyncTask<String, Void, String>{
            ...
            protected String doInBackground(String... params) {
               ...
               // String strrt= getIntent().getStringExtra("phone");;
                ...
                String strrt = getIntent().getStringExtra("g");
                String strrt2 = getIntent().getStringExtra("h");

//                String aa1 = getIntent().getStringExtra("phone");
//                String bb1 = getIntent().getStringExtra("name");

                HttpGet httppost = new HttpGet("http://sultantec.com/files/ad_show_me2.php?id="+strrt+"&id2="+strrt2);
                ...
                if(!strrt.equals("حدد مكان التحرك")){
                    ...
                    httppost = new HttpGet("http://sultantec.com/files/ad_show_me2.php?id="+strrt+"&id2="+strrt2);
...
//                    etUserName.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.rounded_edge3, 0, 0);
    ...
    public void CustomDialog(){
        ...
        demodialog22.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // diss miss the dialog
                dialog.dismiss();
                Intent al = new Intent(Add_j4.this, Requst_t.class);
                startActivity(al);
                overridePendingTransition(R.anim.pull_in_left, R.anim.push_out_right);
            }
        });
    ...
    public void buclickd() {
        ...
        final Dialog dialog = new Dialog(Add_j4.this);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        dialogButtonc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent alvvwefrerxx = new Intent(Add_j4.this, Login.class);
                startActivity(alvvwefrerxx);
                finish();
                overridePendingTransition(R.anim.pull_in_left, R.anim.push_out_right);
            }
