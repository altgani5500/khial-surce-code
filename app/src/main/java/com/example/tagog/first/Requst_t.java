...
public class Requst_t extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.requst_t);
...
//   name     TextView  e1 = (TextView) findViewById(R.id.button);
...
//        String bb2 = getIntent().getStringExtra("name");
        ...
        String bb = name.getText().toString();
        String bb2 = phone.getText().toString();
...
//        }
    ...
    public class SignupActivityda extends AsyncTask<String, Void, String> {
        ...
        {
            super.onPreExecute();
            mProgressDialog = ProgressDialog.show(Requst_t.this,
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                link = "http://sultantec.com/files/req.php" + data;
...
{
///onBackPressed();
    Intent al2 = new Intent(Requst_t.this, MainActivity.class);
    String bb2 = "0";
    String bb3 = "user";


    al2.putExtra("phone", mUsername); al2.putExtra("name", mUsername2);al2.putExtra("id", bb2);al2.putExtra("st", bb3);
    ...
    public void info() {
        ...
        final Dialog dialog = new Dialog(Requst_t.this);
