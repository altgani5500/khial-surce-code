...
public class Add_j2 extends Activity {
...
int vl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_j);
        ...
        etUserName23.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View vvv) {
                ...
                Intent al = new Intent(Add_j2.this, Requst_t.class);
        ...
        etUserName234.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View vvv) {
                ...
                Intent alvvwefrerxx = new Intent(Add_j2.this, Watting.class);


//                String aa1 = getIntent().getStringExtra("go1");
//                String bb1 = getIntent().getStringExtra("go2");
        ...
        etUserName225.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View vvv) {
                ...
                Intent alvvwefrerxx = new Intent(Add_j2.this, Add_j3.class);
...
*/
    ...
    protected void showList(){
        try {
              ...
              // String GG2 ="من"+c.getString(G)+"الي"+c.getString(H);
                ...
                list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int positiona, long id) {
                      ...
                      Intent alvvwefrerxx = new Intent(Add_j2.this, Show_requst_ditils.class);
          ...
          String bb="1";
            ...
            ListAdapter adapter = new SimpleAdapter(Add_j2.this, personList, R.layout.list_item2, new String[]{D,E,B,H,F,G},


                    new int[]{R.id.textViewTitle,R.id.textView19,R.id.textView21,R.id.textViewTitle1,R.id.textView23,R.id.textView32
            ...
            e.printStackTrace();
            Toast.makeText(getApplicationContext(), "gghjj", Toast.LENGTH_LONG).show();
        }
    ...
    public void CustomDialog(){
        ...
        demodialog223.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // diss miss the dialog
                dialog.dismiss();
                Intent al = new Intent(Add_j2.this, New_gi.class);
               String aa = getIntent().getStringExtra("go1");
                String bb = getIntent().getStringExtra("go2");
    ...
    public void buclickd() {
        ...
        final Dialog dialog = new Dialog(Add_j2.this);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        dialogButtonc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent alvvwefrerxx = new Intent(Add_j2.this, Login.class);
                startActivity(alvvwefrerxx);
                finish();
                overridePendingTransition(R.anim.pull_in_left, R.anim.push_out_right);
            }
