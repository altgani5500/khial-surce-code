...
int vl;
      ...
      /*  FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        ...
        etUserName23.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View vvv) {
                ...
                Intent alvvwefrerxx = new Intent(Admin2.this, Jeurney_ok.class);
        ...
        etUserName234.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View vvv) {
                ...
                Intent alvvwefrerxx = new Intent(Admin2.this, Add_news.class);
        ...
        etUserName225.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View vvv) {
                ...
                Intent alvvwefrerxx = new Intent(Admin2.this, Get_users2.class);

               // alvvwefrerxx.putExtra("g", aa1); alvvwefrerxx.putExtra("h", bb1);alvvwefrerxx.putExtra("i", bb2);
                startActivity(alvvwefrerxx);
                overridePendingTransition(R.anim.pull_in_left, R.anim.push_out_right);
    ...
    protected void showList(){
        try {
            ...
            for(int i=v;i>=0;i--){
                ...
                String DD = c.getString(D)+"راس مطلوب نقلها";
              ...
              // String GG2 ="من"+c.getString(G)+"الي"+c.getString(H);
                ...
                list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int positiona, long id) {
                      ...
                      Intent alvvwefrerxx = new Intent(Admin2.this, Showw_detad2.class);
            ...
            ListAdapter adapter = new SimpleAdapter(Admin2.this, personList, R.layout.list_item44, new String[]{J,K,N,M,D,O},


                    new int[]{R.id.textViewTitle,R.id.textView19,R.id.textView21,R.id.textViewTitle1,R.id.textView23,R.id.textView22
    ...
    public void getData(){
        class GetDataJSON extends AsyncTask<String, Void, String>{
            ...
            protected String doInBackground(String... params) {
                ...
                HttpGet httppost=new HttpGet("http://sultantec.com/files/adv_ok_show2.php");
    ...
    public void buclickd() {
        ...
        final Dialog dialog = new Dialog(Admin2.this);
        ...
        dialogButtonc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent alvvwefrerxx = new Intent(Admin2.this, Login.class);
                startActivity(alvvwefrerxx);
                finish();
                overridePendingTransition(R.anim.pull_in_left, R.anim.push_out_right);
            }
    ...
    public void CustomDialog(){
        ...
        demodialog22.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // diss miss the dialog
                dialog.dismiss();
                Intent al = new Intent(Admin2.this, Requst_t.class);
                startActivity(al);
                overridePendingTransition(R.anim.pull_in_left, R.anim.push_out_right);
            }
        });
        ...
        demodialog223.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // diss miss the dialog
                dialog.dismiss();
                Intent al = new Intent(Admin2.this, New_gi.class);
